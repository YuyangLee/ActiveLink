...
dataset_sizes = {"FB15k-237": 149689, "wikidata_300k": 201505, "wikidata_1000k": 634250, "synthetic": 4892}
...
class Config(object):
    ...
    n_clusters = 1000
    sample_size = 128  # number of training examples per one AL iteration
    sampling_mode = "omni_t_uncer"
